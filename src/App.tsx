...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
              ...
              {result.found && result.info ? (
                  ...
                  <div className="space-y-4 text-left px-4">
                    ...
                    {!result.info.github_id ? (
                      ...
                      <p className="text-green-600 text-sm text-center font-medium mt-4">
                        Everything looks good! Your membership and team access are active.
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-red-600">
                    We couldn't find an active RISC-V Groups.io account for <span className="font-bold">{email}</span>.
                  </p>
                  <div className="h-px bg-red-200 w-full my-4" />
                  <div className="text-sm text-red-700 text-left space-y-3">
                    <p>
                      Groups.io is our source of truth to verify RISC-V Membership and Member Representatives.
                    </p>
                    <p>
                      If you are not a RISC-V Member, please visit{' '}
                      <a href="https://riscv.org/members/join/" className="underline font-bold">riscv.org/members/join/</a>.
                    </p>
                    <p>
                      If you are a member representative or hold an individual membership, please send an email to{' '}
                      <a 
                      ...
                      to request access to Groups.io.
                    </p>
                    <p>
                      Once your access is approved, please update your profile at{' '}
      ...
      <footer className="fixed bottom-8 text-berkeley-blue/40 text-sm">
